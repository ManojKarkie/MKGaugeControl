...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of MkGaugeControl.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/manojkarkie@gmail.com/MkGaugeControl'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'manojkarkie@gmail.com' => 'manojkarkie@gmail.com' }
  s.source           = { :git => 'https://github.com/manojkarkie@gmail.com/MkGaugeControl.git', :tag => s.version.to_s }
