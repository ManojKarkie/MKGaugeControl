...
public class MKGaugeView: UIView {
    ...
    public var leftGradientColor  = UIColor.blue
    public var rightGradientColor  = UIColor.red

    public var pathBackgroundColor = UIColor.init(red: 224.0/255.0, green: 225.0/255.0, blue: 225.0/255.0, alpha: 1.0)
    public var needleFillColor =  UIColor(red: 14.0/255.0, green:  14.0/255.0, blue: 15.0/255.0, alpha: 1.0)
    ...
    public unowned var needle: Needle?
    ...
    private func setupNeedle() {
        ...
        needleView.fillColor = self.needleFillColor
        needleView.setupLayer()
...
private extension MKGaugeView {
    ...
    func adjustNeedleValue() {
        if needleValue > maxGaugeLimit {
            needleValue = maxGaugeLimit
        }
    }
